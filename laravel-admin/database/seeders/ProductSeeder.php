...
class ProductSeeder extends Seeder
{
    ...
    {
        $products = [
            ['name' => 'Promo Tortas', 'price' => 45, 'image' => 'img/imagenes/9.jpg', 'description' => 'La promo más destacada de 3 tortas de cochinita pibil o lechón horneado (incluye cebolla y salsa aparte).', 'category' => 'comida', 'active' => true, 'sort_order' => 1, 'has_type' => true, 'has_meat' => true],
            ['name' => 'Promo Tacos', 'price' => 40, 'image' => 'img/imagenes/4.jpg', 'description' => '5 deliciosos taquitos de cochinita pibil o lechón horneado (incluye cebolla curtida y salsa aparte).', 'category' => 'comida', 'active' => true, 'sort_order' => 2, 'has_type' => true, 'has_meat' => true],
            ['name' => 'Taquito de Cochinita', 'price' => 10, 'image' => 'img/imagenes/13.jpg', 'description' => 'Deliciosos tacos de cochinita pibil con tortilla No. 12 (incluye cebolla y salsa aparte).', 'category' => 'comida', 'active' => true, 'sort_order' => 3, 'has_meat' => true],
            ['name' => 'Torta', 'price' => 16, 'image' => 'img/torta12.jpeg', 'description' => 'Delicioso torta de cochinita pibil o lechón horneado (incluye cebolla curtida y salsa verde aparte).', 'category' => 'comida', 'active' => true, 'sort_order' => 4, 'has_type' => true, 'has_meat' => true],
