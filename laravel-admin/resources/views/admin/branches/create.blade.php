...
<head>
    ...
    <title>Nueva Sucursal - Admin</title>
    ...
    <div class="content">
        <form method="POST" action="{{ route('admin.branches.store') }}">
            ...
            <div class="card">
                ...
                <div class="form-grid">
                    <div class="full form-group">
                        ...
                        <p class="hint">La clave (key) de la sucursal se genera automáticamente del nombre.</p>
                    </div>
                    <div class="full form-group">
                        <label>Dirección</label>
                        <textarea name="address" placeholder="Dirección completa de la sucursal">{{ old('address') }}</textarea>
                        @error('address') <p style="color:#e74c3c;font-size:0.65rem;margin-top:4px">{{ $message }}</p> @enderror
                    </div>
                    <div class="form-group">
                        <label>Teléfono</label>
                        <input type="text" name="phone" placeholder="993 309 2124" value="{{ old('phone') }}">
                        @error('phone') <p style="color:#e74c3c;font-size:0.65rem;margin-top:4px">{{ $message }}</p> @enderror
                    </div>
                    <div class="form-group">
                        <label>WhatsApp</label>
                        <input type="text" name="whatsapp" placeholder="529933092124" value="{{ old('whatsapp') }}">
                    ...
                    <div class="form-group">
                        <label>Latitud</label>
                        <input type="number" step="any" name="latitude" placeholder="17.9865" value="{{ old('latitude') }}">
                        @error('latitude') <p style="color:#e74c3c;font-size:0.65rem;margin-top:4px">{{ $message }}</p> @enderror
                    </div>
                    <div class="form-group">
                        <label>Longitud</label>
                        <input type="number" step="any" name="longitude" placeholder="-92.9531" value="{{ old('longitude') }}">
                    ...
                    <div class="full form-group">
                        ...
                        <input type="text" name="schedule_text" placeholder="Lunes a Domingo de 7:00 am a 2:00 pm" value="{{ old('schedule_text') }}">
                    </div>
                    <div class="full form-group">
                        <label>URL Didi Food</label>
                        <input type="text" name="didi_url" placeholder="https://www.didi-food.com/..." value="{{ old('didi_url') }}">
                    </div>
                    <div class="form-group">
                        <label>Orden</label>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Guardar sucursal</button>
            </div>
        </form>
    </div>
