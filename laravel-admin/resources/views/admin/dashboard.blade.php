    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .add-btn {
            ...
            border: none; padding: 8px 16px; border-radius: 8px; font-family: 'Poppins', sans-serif;
            font-size: 0.8rem; font-weight: 600; cursor: pointer; transition: all 0.3s ease;
            text-decoration: none; display: inline-flex; align-items: center; gap: 6px;
        }
        .add-btn:hover { transform: translateY(-2px); box-shadow: 0 4px 12px rgba(76,175,80,0.3); }
        ...
        /* ── Success Banner ── */
        .success-banner {
            margin: 16px 24px 0; padding: 12px 16px; background: #e8f5e9; border-radius: 10px;
        ...
        .category-header h2 { font-size: 1rem; font-weight: 700; color: #1a1a1a; }
        .category-header .category-count {
            background: #FF6B35; color: white; padding: 2px 10px; border-radius: 20px;
            font-size: 0.75rem; font-weight: 600;
        }
        .category-header i { font-size: 1.2rem; color: #FF6B35; }
        ...
        .product-info { flex: 1; display: flex; align-items: center; gap: 12px; }
        .product-img {
            width: 48px; height: 48px; border-radius: 10px; object-fit: cover;
            background: #f0f0f0; flex-shrink: 0;
        }
        .product-details { flex: 1; }
        .product-name { font-weight: 600; font-size: 0.9rem; color: #1a1a1a; }
        .product-price { color: #FF6B35; font-weight: 700; font-size: 0.9rem; }
        .product-status { font-size: 0.7rem; color: #888; margin-top: 2px; }
        ...
        /* ── Toggle Switch ── */
        .toggle { position: relative; width: 52px; height: 28px; flex-shrink: 0; margin-left: 8px; }
        .toggle input { opacity: 0; width: 0; height: 0; position: absolute; }
        .toggle-slider {
            position: absolute; cursor: pointer; top: 0; left: 0; right: 0; bottom: 0;
            background: #ddd; border-radius: 28px; transition: all 0.3s ease;
        }
        ...
        .modal-card h3 { font-size: 1.1rem; font-weight: 700; color: #1a1a1a; margin-bottom: 10px; display: flex; align-items: center; gap: 8px; }
        .modal-card h3 i { color: #e53935; }
        .modal-card p { color: #666; font-size: 0.9rem; margin-bottom: 24px; }
        ...
        @media (max-width: 480px) {
            ...
            .stat-card { display: flex; align-items: center; justify-content: space-between; padding: 12px 16px; text-align: left; }
            .stat-card .stat-number { font-size: 1.4rem; }
            .product-row { padding: 12px; flex-wrap: wrap; gap: 8px; }
